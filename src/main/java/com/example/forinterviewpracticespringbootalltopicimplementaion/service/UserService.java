...
public ModifyUserDTO create(AddUserDto dto) {
    ...
    @Transactional
    @Auditable(action = ActionConstants.UPDATE, entity = EntityConstants.USER, isDeleted =false)
    ...
    @Transactional
    @Auditable(action = ActionConstants.DELETE, entity = EntityConstants.USER,isDeleted= true)
